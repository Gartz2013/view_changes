...
class ChangesControllerTest < ActionController::TestCase
  ...
  test "should create change" do
    assert_difference('Change.count') do
      post :create, change: { description: @change.description, size: @change.size, title: @change.title, version: @change.version }
    end
  ...
  test "should update change" do
    patch :update, id: @change, change: { description: @change.description, size: @change.size, title: @change.title, version: @change.version }
    assert_redirected_to change_path(assigns(:change))
  end
